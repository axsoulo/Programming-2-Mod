LOVELY_INTEGRITY = 'bec77ccd040dc95888e1659cc69dca176d9e413987e9be8db0e4bf9929d49888'
    ...
    local t = {n=G.UIT.ROOT, config = {align = 'cm', r = 0.1}, nodes={
      ...
      {n=G.UIT.R, config={align = "cm", padding = 0.05}, nodes={
        ...
        {n=G.UIT.R, config={align = "cm", padding = 0.05}, nodes={
          ...
          {n=G.UIT.R, config={align = "cm", padding = 0.00}, nodes={
              {n=G.UIT.T, config={text = "press [A/S/D] to toggle Eternal/Perishable/Rental", scale = 0.25, colour = G.C.WHITE, shadow = true}}
          }},
          {n=G.UIT.R, config={align = "cm", padding = 0.00}, nodes={
          ...
          {n=G.UIT.R, config={align = "cm", padding = 0.00}, nodes={
              {n=G.UIT.T, config={text = "press [UP/DOWN] to cycle rank", scale = 0.25, colour = G.C.WHITE, shadow = true}}
          }},
          {n=G.UIT.R, config={align = "cm", padding = 0.00}, nodes={
              {n=G.UIT.T, config={text = "press [RIGHT/LEFT] to cycle suit", scale = 0.25, colour = G.C.WHITE, shadow = true}}
          }},
          {n=G.UIT.R, config={align = "cm", padding = 0.00}, nodes={
